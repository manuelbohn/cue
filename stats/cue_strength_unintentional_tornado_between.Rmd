---
title: "CueStrength unintentional tornado"
author: "Manuel Bohn"
date: "17 3 2018"
...
```{r}
## importing data
d <- read_csv(file="cue_unintentional_tornado_between.data.csv")%>%
...
Effect usually stronger for inner compared to outer, this time it seems to be the other way around.
