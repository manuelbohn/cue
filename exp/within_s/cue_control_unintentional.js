...
// recording the choice 
  choice: function(event) {
    ...
    $("#text2").text("")  
    setTimeout(function() {$("#text2").text("Click on the toy")}, 4000);
...
//        }, 2000)
  ...
  setTimeout(function() {
            ...
            setTimeout(function() {
                ...
                $("#"+agents[0]+"_straight").animate({width: "160px", left: "400px", bottom:"600px",opacity: '0.5', queue: false},125);
                $("#"+agents[0]+"_straight").animate({width: "180px", left: "430px", bottom:"520px",opacity: '1', queue: true},125)   
            }, 1350);
        };
    };
