   ...
   if (experiment.agentOrient[0][0] == "straight") { 
    ...
    if (experiment.agentOrient[0][0] == "torn"){  
      ...
      setTimeout(function() {              
            ...
            $("#tornado").animate({bottom: "300px",left: "410px", queue: false},700);
            $("#tornado").animate({bottom: "400px",left: "350px", queue: true},533);
            $("#tornado").animate({bottom: "300px",left: "470px", queue: true},533);
        
            $("#tornado").animate({bottom: "400px",left: "410px", queue: true},633);
            $("#tornado").animate({bottom: "900px",left: "410px", queue: true},500);         
            
            
   setTimeout(function() {
                $("#"+agents[0]+"_straight").animate({width: "160px", left: "390px", bottom:"400px",opacity: '0.5', queue: false},200)
    
                $("#"+agents[0]+"_straight").animate({width: "160px", left: "470px", bottom:"370px",opacity: '0.5', queue: true},200) 
            ...
            setTimeout(function() {
                showAgent(agents[0],"look_l");
                $("#"+agents[0]+"_look_l").animate({width: "160px", left: "400px", bottom:"400px",opacity: '0.5', queue: false},250);
                $("#"+agents[0]+"_look_l").animate({width: "180px", left: "460px", bottom:"320px",opacity: '1', queue: true},250)   
            }, 1900); 
      
            setTimeout(function() {
                showAgent(agents[0],"look_r");
                $("#"+agents[0]+"_look_r").animate({width: "160px", left: "400px", bottom:"340px",opacity: '0.5', queue: false},250);
                $("#"+agents[0]+"_look_r").animate({width: "180px", left: "410px", bottom:"320px",opacity: '1', queue: true},250)   
            }, 2350); 
            
            
            setTimeout(function() {    
                $("#fruit_l").animate({left: "140px", opacity: 0},2000);
            }, 2800)    
         ...
         setTimeout(function() {              
            ...
            setTimeout(function() {    
                $("#fruit_r").animate({left: "760px", opacity: 0},1500);
            }, 2800)  
            ...
            setTimeout(function() {    
                $("#fruit_r").animate({left: "760px", opacity: 0},2000);
            }, 2800)
            ...
            setTimeout(function() {
             ...
             setTimeout(function() {    
                $("#fruit_l").animate({left: "130px", opacity: 0},2000);
            }, 2800)
        };
    };
