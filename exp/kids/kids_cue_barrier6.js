...
var preSounds = ["Frog_intro.mp3",
                 "ticon_label.mp3", "ticon_touch.mp3","ticon_which.mp3",
                 "oscot_label.mp3", "oscot_touch.mp3","oscot_which.mp3",
                 "zoyar_label.mp3", "zoyar_touch.mp3","zoyar_which.mp3",
                 "kepel_label.mp3", "kepel_touch.mp3","kepel_which.mp3",
                 "glipsa_label.mp3", "glipsa_touch.mp3","glipsa_which.mp3",
                 "toma_label.mp3", "toma_touch.mp3","toma_which.mp3",
                 "zubi_label.mp3", "zubi_touch.mp3","zubi_which.mp3",
                 "wiso_label.mp3", "wiso_touch.mp3","wiso_which.mp3",
                 "end.mp3", "more_robots.mp3"];
//for critical trials and fillers
var sound = new Array();
...
// what happens between trials - display agent from previous trial and click on it to move on to the next trial    
  ...
  if (experiment.inf[0]=="left" && experiment.targetSwitch[0] == "stay") {
           ...
           } else if (experiment.inf[0]=="right" && experiment.targetSwitch[0] == "stay") {
...
// recording the choice 
  choice: function(event) {
    ...
    // show control barrier
      ...
      sound.find(function (obj){return obj.id == "more_robots.mp3"}).play();
...
// moving on within a trial
  ...
  // after exposure is finished, switch to choice      
    ...
    // show agent
      ...
      if (experiment.agentOrient[0][0] == "straight" && experiment.trial[0] == "filler1") {
      ...
      } else if (experiment.agentOrient[0][0] == "straight" && experiment.trial[0] != "filler1") {
          ...
          $("#"+friends[0]+"_l").animate({opacity: '0', queue: false},1000)
          ...
          $("#"+friends[0]+"_r").animate({opacity: '0', queue: false},1000)
