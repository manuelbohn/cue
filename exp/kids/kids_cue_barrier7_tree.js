...
function showLeftFriend() {
	$(".tree_l").hide();
	$("#tree_l").show();
}

function showRightFriend() {
	$(".friend_r").hide();
	$("#tree_r").show();
}


function showLeftChoiceFriend() {
    $(".friend_l").hide();
	$("#tree_l_c").show();
}

function showRightChoiceFriend() {
	$(".tree_r").hide();
	$("#tree_r_c").show();
}
...
for (i = 0; i < preSounds.length; i++) {
	sound[i] = new Audio();
	sound[i].src = "sound2/" + preSounds[i];
...
// recording the choice 
  choice: function() {
    ...
    showLeftChoiceFriend()
     
    showRightChoiceFriend()
...
if (experiment.targetSwitch[0] == "stay") {
    ...
    // data collected  
      data = {
        subid: subid,
        subage: subage,
        experiment: "cue_trees_point_talk_map",
        trial: trial[0],
        cue: cond[0],
        control: control[0],
        agent: agents[0],
       ...
       sourceLeftFruit("images/"+leftFruit[0]+".png");
        ...
        sourceRightFruit2("images/"+rightFruit[0]+".png");
         ...
         if (experiment.targetPosition[0] == "upper"){
          ...
          $("#tree_l").animate({opacity: '0', queue: false},1000)
          ...
          $("#tree_r").animate({opacity: '0', queue: false},1000)
